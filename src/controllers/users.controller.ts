...
export class UsersController {
  ...
  public getAllUsers = async (req: Request, res: Response) => {
    ...
    try {
      ...
      const userPerPage: number = +limit! || 10;
  ...
  public getPublicUserDeck = async (req: Request, res: Response) => {
    ...
    const { isValid, message } = validator.validatePublicUserDeckSearchQuery(
      String(page),
      String(limit),
      String(q)
    );
   ...
   *         description: Internal server error
   */
  public getSpecificUserDeck = async (req: Request, res: Response) => {
