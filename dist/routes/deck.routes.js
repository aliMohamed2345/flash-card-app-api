...
const router = Router();
const { getAllUserDeck, createNewDeck, getSpecificDeck, updateUserDeck, deleteUserDeck, toggleDeckVisibility, downloadDeckJson, downloadDeckExcel, getUserStats, } = new DeckController();
